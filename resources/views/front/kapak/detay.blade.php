...
@section('content')
    ...
    <div class="row page-title clearfix">
        <div class="page-title-left ">
            <h6 class="page-title-heading mr-0 mr-r-5">Kapak</h6>
                    ...
                    <div class="widget-body clearfix">
                        <div class="widget-user-profile">
                            ...
                            <div class="profile-body">
                                ...
                                <div class="mb-3 mt-3">
                                    <a href="{{ route('kapak.edit',['id'=>$urunData[0]['id']]) }}" class="btn btn-outline-color-scheme btn-rounded btn-lg px-5 border-thick text-uppercase mr-2 mr-0-rtl ml-2-rtl fw-700 fs-11 heading-font-family">Kapak Düzenle</a>
