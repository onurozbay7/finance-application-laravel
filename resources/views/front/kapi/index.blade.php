...
@section('content')
    ...
    <div class="row page-title clearfix d-print-none">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Kapı Listesi</h6>
        ...
        <div class="page-title-right d-none d-sm-inline-flex d-print-none">
            ...
            <div class="d-none d-md-inline-flex justify-center align-items-center d-print-none">
                <a href="{{ route('kapi.create') }}" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-10 pd-lr-10 mr-l-0-rtl mr-r-10-rtl hidden-xs hidden-sm ripple">Kapı Ekle</a>
            </div>
        </div>
        <!-- /.page-title-right -->
    </div>
