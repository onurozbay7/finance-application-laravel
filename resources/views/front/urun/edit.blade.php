            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form id="form" action="{{ route('urun.update',['id'=>$data[0]['id']]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-4 px-3">
                                    ...
                                    <select required name="urunTipi" id="urunTipi" class="m-b-10 form-control" data-placeholder="Ürün Tipi Seçiniz" data-toggle="select2">
                                        ...
                                        <option value="MDF" @if($data[0]['urunTipi'] == "MDF") selected @endif>MDF</option>
                                        <option value="Hırdavat" @if($data[0]['urunTipi'] == "Hırdavat") selected @endif>Hırdavat</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4 px-3">
                                    <div class="form-group">
                                        ...
                                        <input name="text" id="text" value="{{ $data[0]['text'] }}" class="form-control" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 px-3">
                                    ...
                                    <input required class="form-control stok" value="{{ $data[0]['stok'] }}" id="stok" name="stok" type="number">
                                </div>

                                <div class="col-md-4 px-3">
                                    <label class=" col-form-label" for="l0">ÜRÜN TARİHİ</label>
                                    <input class="form-control" required name="urunTarihi" value="{{ $data[0]['urunTarihi'] }}" type="date">
                                </div>
