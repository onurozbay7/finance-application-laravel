...
@section('content')
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Personel <small> İşlem Yap</small> </h6>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form id="form" action="{{ route('personelIslem.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-4 px-3">
                                    <div class="form-group">
                                        ...
                                        <select name="islemTipi" class="m-b-10 form-control" data-placeholder="İşlem Seçiniz" data-toggle="select2">
                                            <option value="1">Maaş Öde</option>
                                            <option value="0">Avans Ver</option>
                                ...
                                <div class="col-md-4 px-3">
                                    ...
                                    <div class="col-md-4 px-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="text" class="form-control" id="" cols="30" rows="1"></textarea>
                                        </div>
                                    </div>
                            </div>
