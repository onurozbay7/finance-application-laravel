...
@section('content')
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Fiş <small> Gider Fişi Ekle</small></h6>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{ route('fis.store',['type'=>FATURA_GIDER]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
