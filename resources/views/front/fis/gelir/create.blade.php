...
@section('content')
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Fiş <small> Gelir Fişi Ekle</small></h6>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{ route('fis.store',['type'=>FATURA_GELIR]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-4 px-3">
                                    <label class=" col-form-label" for="l0">Fiş No</label>
                                    <input required class="form-control" id="faturaNo" name="faturaNo" type="text">
                                </div>

                                <div class="col-md-4 px-3">
                                    <label class="col-form-label" for="l0">Müşteri Seçiniz</label>
                                    <select required name="musteriId" class="m-b-10 form-control" data-placeholder="Müşteri Seçiniz" data-toggle="select2">
                                ...
                                <div class="col-md-4 px-3">
                                    <label class=" col-form-label" for="l0">Fiş Tarihi</label>
                                    <input class="form-control" id="faturaTarih" required name="faturaTarih" value="{{ date("Y-m-d") }}" type="date">
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table id="faturaData" class="table">
                                        ...
                                        <tr class="islem_field">
                                            <td><select required name="islem[0][urun]" style="width: 100%" class="form-control" data-placeholder="Mdf veya Hırdavat Seçiniz" data-toggle="select2">
                                                <option value="0">Ürünsüz Fiş Girişi (Stoktan Düşmez)  </option>
                                                @foreach(\App\Models\Urun::all() as $k => $v)
                                                    <option value="{{$v['id']}}">{{ $v['urunTipi'] }} | {{ $v['text'] }} | {{ $v['stok'] }}</option>
                                                @endforeach
                                                </select></td>
                                            <td><input type="text" class="form-control" id="text" name="islem[0][text]"></td>
                                            <td><input type="text" class="form-control" required id="adet" name="islem[0][adet]"></td>
                                            <td><input type="text" class="form-control" required id="tutar" name="islem[0][tutar]"></td>
                                            <td><input type="text" class="form-control" required id="toplam_tutar" name="islem[0][toplam_tutar]"></td>
                                            <td><input type="text" class="form-control" required id="kdv" name="islem[0][kdv]"></td>
                                            <td><input type="text" class="form-control" required id="kdv_toplam" name="islem[0][kdv_toplam]"></td>
                                            <td><input type="text" class="form-control" required id="genel_toplam" name="islem[0][genel_toplam]"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
...
@section('footer')
    ...
    /*    $("#kaydet").click(function (){
        ...
        $("#addRowBtn").click(function (){
            ...
            var newRow =
                '<tr class="islem_field">'+
                '<td><select required name="islem['+i+'][urun]" style="width: 100%" class="form-control" data-placeholder="Mdf veya Hırdavat Seçiniz" data-toggle="select2">' +
                '<option value="0">Ürünsüz Fiş Girişi (Stoktan Düşmez)  </option>' +
                '@foreach(\App\Models\Urun::all() as $k => $v)' +
                ' <option value="{{$v['id']}}">{{ $v['urunTipi'] }} | {{ $v['text'] }} | {{ $v['stok'] }}</option>' +
                '@endforeach' +
                ...
                '<td><input type="text" class="form-control" required id="adet" name="islem['+i+'][adet]"></td>'+
                '<td><input type="text" class="form-control" required id="tutar" name="islem['+i+'][tutar]"></td>'+
                '<td><input type="text" class="form-control" required id="toplam_tutar" name="islem['+i+'][toplam_tutar]"></td>'+
                '<td><input type="text" class="form-control" required id="kdv" name="islem['+i+'][kdv]"></td>'+
                '<td><input type="text" class="form-control" required id="kdv_toplam" name="islem['+i+'][kdv_toplam]"></td>'+
                '<td><input type="text" class="form-control" required id="genel_toplam" name="islem['+i+'][genel_toplam]"></td>'+
