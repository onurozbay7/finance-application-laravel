...
@section('content')
    ...
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Personel Listesi</h6>
        ...
        <div class="page-title-right d-none d-sm-inline-flex">
            ...
            <div class="d-none d-md-inline-flex justify-center align-items-center">
                <a href="{{ route('personel.create') }}" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple">Personel Ekle</a>
