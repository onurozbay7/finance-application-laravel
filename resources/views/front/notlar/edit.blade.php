            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form action="{{ route('notlar.update', ['id' => $data[0]['id']]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-4 px-3">
                                    ...
                                    <input class="form-control" required name="baslik" type="text" value="{{ $data[0]['baslik'] }}">
                                </div>

                                <div class="col-md-12 px-3">
                                    <div class="form-group">
                                        <label class=" col-form-label" for="l0">Açıklama</label>
                                        <textarea name="icerik" class="form-control" id="" cols="30" rows="5">{{ $data[0]['icerik'] }}</textarea>
                                    </div>
                                </div>
