                        ...
                        <form action="{{ route('kalem.update',['id'=>$data[0]['id']]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <input type="radio" class="change-cumstomerType" @if($data[0]['kalemTipi'] == 0) checked @endif name="kalemTipi" value="0"> Gelir
                                    </div>
                                    <div>
                                        <input type="radio" class="change-cumstomerType" @if($data[0]['kalemTipi'] == 1) checked @endif name="kalemTipi" value="1"> Gider
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row firma--area">
                                ...
                                <div class="col-md-6 px-3">
                                    ...
                                    <input class="form-control" required name="kdv" type="text" value="{{ $data[0]['kdv'] }}">
                                </div>
