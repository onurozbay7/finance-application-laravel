...
@section('content')
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">İşlem <small> Tahsilat Al</small></h6>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form id="form" action="{{ route('islem.store',['type'=>1]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 px-3">
                                    ...
                                    <input required class="form-control fiyat" name="fiyat" type="text">
                                </div>
                            </div>
